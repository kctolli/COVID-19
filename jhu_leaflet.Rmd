...
maps %>% 
  ...
  addLayersControl(overlayGroups = c("cases", "case %", "deaths", "death %"))
```

This is an interactive map called a leaflet. I set up overlay groups, you can choice between cases, case percent, deaths, death percent. The color defines the value of the group you select. See [New York Times Maps](https://kctolli.github.io/COVID-19/ny.html#Maps) for exact values. 

...
state <- my_read("https://github.com/BYUI-COVID/read-data/raw/master/nytimes/nytimes_state_pop.csv") %>% 
  mutate(`pop/mil` = pop/1000000)

state_prop <- my_read("https://github.com/BYUI-COVID/read-data/raw/master/nytimes/nytimes_state_proportions.csv")

county_prop <- my_read("https://github.com/BYUI-COVID/read-data/raw/master/nytimes/nytimes_county_proportions.csv")
```
...
This plot shows the percent of the population that has died for COVID-19 in the counties of New York.
